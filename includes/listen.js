...
//////dọn cache khi onbot!////////////////////////////////////////////////////////////
  ...
  api.sendMessage('Bot vừa khởi động xong và đã tự động dọn dẹp cache!', NDH);
//////////////////////////////////////////////////////////////////////
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "This bot was made by Khanh Shado" : global.config.BOTNAME}`, "[ BOT INFO ]");
