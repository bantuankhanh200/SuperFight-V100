...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["chào bạn tôi là bot của Khanh Shado", "bạn gọi tôi có việc gì k ạ", "tôi yêu bạn lắm lắm bạn nhớ tương tác nha ", "Yêu cậu <3", "Hi, chào con ny của bot nha :3", "gọi min có việc gì không?", "Sử dụng callad để liên lạc với admin!", "Em là bot cute nhất hành tinh", "Nói gì thế bé ", "Bot đây~~~~", "Yêu admin nhất", "bot là cực cưng của của min ", "Yêu thương admin nhất", "Gọi bot có việc gì không dạ ", "Sao thế  bae=)^^ ", "Đừng làm em đau ~~~~ hic :(", "Yêu bé ❤", "Tuyển phi công nè ạ", "Làm bồ em ko ạ? dui lắm", "Cậu cô đơn ko?", "Tuyển ghệ đút bự đi bay lắc", "Được của nó  :)))", "Em dthw như chủ của em ạ", "Đừng khen em ngại quá hí hí" ,"Làm ny e ko ạ?", "Đừng spam em nha :<<", "biến đi sapm cái gì", "Bằng láu hủ tiếu kinh nghiêm đầy minh tuyển ghệ đít bự", "đừng spam bay bot đó", "Omg yêu mọi người ❤", "Spam gì đó tính yêu admin à ư ư ư ", "Yêu bot🙄 ko?", "Ny em đây rồi"];
...
if ((event.body.toLowerCase() == "hí") || (event.body.toLowerCase() == "hi")) {
 ...
 if ((event.body.toLowerCase() == "bsvv nha mn") || (event.body.toLowerCase() == "bsvv nha mn")) {
  ...
  if ((event.body.toLowerCase() == "admin m là ai v bot") || (event.body.toLowerCase() == "admin m la ai v bot")) {
    return api.sendMessage("️Admin tao là Khanh Shado, có gì liên hệ nhé!", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "dm") || (event.body.toLowerCase() == "bot im di")) {
    return api.sendMessage("Lịch Sự Tí Ik :) ?", threadID);
  };
