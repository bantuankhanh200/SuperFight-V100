...
module.exports.languages = {
  "vi": {
    "returnResult": "====[ UPTIME ]====\n⏳ - Bot đã hoạt động được %1 giờ %2 phút %3 giây.\n---- Database ----\n👥 - Tổng người dùng: %4\n🏘️ - Tổng Nhóm: %5\n⚙️ - Cpu đang sử dụng: %6%\n🛠️ - Ram đang sử dụng: %7\n📌 - Ping: %8ms\n👉 Request: %9"
  },
  "en": {
...
module.exports.run = async ({ api, event, getText }) => {
  ...
  const name = await global.data.userName.get(event.senderID) || await Users.getNameUser(event.senderID);
